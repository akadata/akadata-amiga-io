# GARY (Gate Array) Pin Mapping Documentation

Based on GARY specification documents and Amiga Hardware Reference for A2000/A3000 systems.

## GARY (Commodore 8520/8521) Pin Mapping

### Physical Package
- **Package**: 48-pin Plastic Leaded Chip Carrier (PLCC)
- **Chip**: GARY (Gate ARRay) - System Control Chip
- **Function**: System control, memory management, interrupt routing, IDE interface
...
#### IDE Interface Signals - Pins 41-44
...
#### System Control Signals - Pins 45-48
...
#### Ground and Additional Control - Pins 32-36 (additional)
- **GND (Pins 8, 16, 24, 32, 40)**: Ground reference
- **CLK (Pin 32)**: System clock input (28.37516/28.63636 MHz)
- **INT2* (Pin 33)**: Interrupt Level 2 (output, active low)
- **INT6* (Pin 34)**: Interrupt Level 6 (output, active low)
- **INT7* (Pin 35)**: Interrupt Level 7 (output, active low)

## GARY Register Mapping to Physical Signals

### GARY Control Register (GARY_CTRL) - Memory Mapped at $DE0000
...
- **Interrupt Routing**: Level 2, 6, 7 interrupt routing
...
- **Slow RAM**: Through trapdoor expansion
- **Memory Mapping**: Controlled via GARY configuration
...
- Improved expansion slot handling
...
- **Expansion Interrupt**: Configurable level
...
- **Priority**: Configurable via system setup
