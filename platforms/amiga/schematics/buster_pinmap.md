...
- **MA0 (Pin 45)**: Memory address bit 0 (output)
- **MA1 (Pin 46)**: Memory address bit 1 (output)
- **MA2 (Pin 47)**: Memory address bit 2 (output)
- **MA3 (Pin 48)**: Memory address bit 3 (output)
- **MA4 (Pin 49)**: Memory address bit 4 (output)
- **MA5 (Pin 50)**: Memory address bit 5 (output)
- **MA6 (Pin 51)**: Memory address bit 6 (output)
- **MA7 (Pin 52)**: Memory address bit 7 (output)

#### Memory Address Extension - Pins 53-56
- **MA8 (Pin 53)**: Memory address bit 8 (output)
- **MA9 (Pin 54)**: Memory address bit 9 (output)
- **MA10 (Pin 55)**: Memory address bit 10 (output)
- **MA11 (Pin 56)**: Memory address bit 11 (output)
...
## BUSTER Register Mapping to Physical Signals

### BUSTER Control Register (BUSTER_CTRL) - Memory Mapped at $DD0000
- **CHIPRST (bit 15)**: Chip reset control
- **MEMRST (bit 14)**: Memory reset control
- **CLKRST (bit 13)**: Clock reset control
- **BUSRST (bit 12)**: Bus reset control
...
### BUSTER Configuration Register (BUSTER_CONFIG) - Memory Mapped at $DD0004
...
### BUSTER Refresh Control Register (BUSTER_REFRESH) - Memory Mapped at $DD0006
...
### BUSTER DRAM Control Register (BUSTER_DRAM_CTRL) - Memory Mapped at $DD0008
...
### BUSTER Chip Select Control Register (BUSTER_CHIPSEL) - Memory Mapped at $DD000A
...
- **Address Outputs**: MA0-MA11 for DRAM addressing
...
- **Chip RAM**: Direct access through BUSTER
- **Fast RAM**: Through expansion bus
- **Memory Mapping**: Controlled via BUSTER configuration
