# RAMSEY Timing Documentation

Based on RAMSEY specification documents and Amiga Hardware Reference for A4000/A3000 systems.

## Overview
RAMSEY is the memory control chip for A4000/A3000 systems responsible for:
- Chip RAM control and timing
...
### Address Space
- Base address: $DD0000 (A4000/A3000 specific)
- Address range: $DD0000 - $DDFFFF (64KB)
- RAMSEY registers: $DD0000 - $DD001F (32 bytes)
...
- All RAMSEY registers can be accessed at any time
...
- RAMSEY controls memory access timing
...
- CPU access to RAMSEY registers may be delayed during heavy memory access
